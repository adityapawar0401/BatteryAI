...
The UI explains this capability state and continues to support validation, local pairing and optional local-Ollama suggestions. Browser numerical ML and local suggestion generation remain separate capabilities.
